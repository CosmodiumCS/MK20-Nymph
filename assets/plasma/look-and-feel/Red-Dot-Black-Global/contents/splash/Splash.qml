...
Image {
    id: root
    source: "images/Red-dit-No Plasma Logo.png"
    ...
    LinearGradient  {
        ...
        source: text
        gradient: Gradient {
             GradientStop { position: 0; color: "#b20048" }
             GradientStop { position: 0.4; color: "#b20048" }
             GradientStop { position: 0.6; color: "#020304" }
